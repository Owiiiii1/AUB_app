          ...
          child: Column(
            children: [
              ...
              Align(
                ...
                child: Text(
                  '${AppStrings.enrolledStudents} (${widget.profile.children.length})'
                      .toUpperCase(),
                  style: AubText.labelCaps,
                ),
              ),
              const SizedBox(height: AubSpacing.xs),
              if (widget.profile.children.isEmpty)
                const Align(
                  alignment: Alignment.centerLeft,
                  child: Text(AppStrings.noChildren, style: AubText.bodySm),
                )
              else
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child: Text(child.displayName, style: AubText.labelMd),
                          ),
                          Text(
                            child.academyClass?.name ?? AppStrings.noClass,
                            style: AubText.labelCaps,
                          ),
                        ],
                      ),
